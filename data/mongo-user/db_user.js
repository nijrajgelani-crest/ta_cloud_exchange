...
db.cls_business_rules.insert({ "name": "All", "filters": { "query": "alert_type IN (\"anomaly\", \"Compromised Credential\", \"policy\", \"Legal Hold\", \"malsite\", \"Malware\", \"DLP\", \"Security Assessment\", \"watchlist\", \"quarantine\", \"Remediation\", \"uba\") || event_type IN (\"page\", \"application\", \"audit\", \"infrastructure\", \"network\")", "mongo": "{\"$or\":[{\"alert_type\":{\"$in\":[\"anomaly\",\"Compromised Credential\",\"policy\",\"Legal Hold\",\"malsite\",\"Malware\",\"DLP\",\"Security Assessment\",\"watchlist\",\"quarantine\",\"Remediation\",\"uba\"]}},{\"event_type\":{\"$in\":[\"page\",\"application\",\"audit\",\"infrastructure\",\"network\"]}}]}" }, "muteRules": [], "muted": false, "unmuteAt": null, "siemMappings": {} })